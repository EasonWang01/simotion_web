...
var		var_MaxPos_Y1 = ["unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Ypos"];	
var     var_MinPos_Y1 = ["unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Yneg"];	
var		var_MaxPos_Z1 = ["unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Zpos"];	
var		var_MinPos_Z1 = ["unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Zneg"]; 
...
function	Read(id)
{
	...
	else if(id == "btn_ReadMaxPos_Y1")
	{
		...
		writeValueFN(tmpValue, "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Ypos");	
		ReadValue(id_MaxPos_Y1, var_MaxPos_Y1);
	}
	else if(id == "btn_ReadMinPos_Y1")
	{
		var tmpValue = document.getElementById("inp_Y1_Postion").value;	
		writeValueFN(tmpValue, "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Yneg");	
		ReadValue(id_MinPos_Y1, var_MinPos_Y1);
	}
	else if(id == "btn_ReadMaxPos_Z1")
	{
		var tmpValue = document.getElementById("inp_Z1_Postion").value;	
		writeValueFN(tmpValue, "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Zpos");
		ReadValue(id_MaxPos_Z1, var_MaxPos_Z1);
	}
	else if(id == "btn_ReadMinPos_Z1")
	{
		var tmpValue = document.getElementById("inp_Z1_Postion").value;	
		writeValueFN(tmpValue, "unit/dHdGlobal.gsHMIdata.sWorkingZone.r64Zneg");
		ReadValue(id_MinPos_Z1, var_MinPos_Z1);
	}
}