...
//模式1
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "inp_ClampL";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sProductZone.r64PickerL";
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "inp_ClampW";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sProductZone.r64PickerW";
    ...
    SubscriptionData.ItemList[SubscriptionData.LastIndex].id = "inp_ClampH";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].style = "default";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemPath = "SIMOTION";

    SubscriptionData.ItemList[SubscriptionData.LastIndex].itemName = "unit/dHdGlobal.gsHMIdata.sProductZone.r64PickerH";
